  ...
  return (
    <section className="mt-30">
      <Container>
        ...
        />
        <div className="grid grid-flow-col auto-cols-[85%] grid-rows-[auto_auto_auto_auto] overflow-x-auto scrollbar-hide sm:grid-flow-row sm:grid-cols-2 sm:grid-rows-[repeat(8,auto)] gap-4 mt-8">
